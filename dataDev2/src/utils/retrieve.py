...
class Retriever:
    ...
    def retrieve_multiple(self, names: list, options: dict | None, prompt: str, print_responses: bool = False, tries: int = 2, expect_result: bool = False, model_source: str = 'OpenAI', model: str = 'gpt-4o-mini') -> dict:
        """
